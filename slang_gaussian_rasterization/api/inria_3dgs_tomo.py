...
from slang_gaussian_rasterization.internal.tomography_tiled_slang import render_alpha_blend_tomo_tiles_slang_raw
...
def render(viewpoint_camera, pc, pipe, bg_color, scaling_modifier = 1.0, override_color = None):
  ...
  render_pkg = render_alpha_blend_tomo_tiles_slang_raw(xyz_ws, rotations, scales, opacity,
