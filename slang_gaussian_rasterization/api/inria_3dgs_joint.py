...
def common_properties_from_inria_GaussianModel(gaussian_model):
  ...
  return xyz_ws, rotations, scales, sh_coeffs, opacity, density
...
def render(viewpoint_camera, pc, pipe, bg_color, scaling_modifier = 1.0, override_color = None):
  ...
  xyz_ws, rotations, scales, sh_coeffs, opacity, density = common_properties_from_inria_GaussianModel(pc)
